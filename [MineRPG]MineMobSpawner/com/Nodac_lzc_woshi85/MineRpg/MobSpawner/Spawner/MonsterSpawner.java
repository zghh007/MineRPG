package com.Nodac_lzc_woshi85.MineRpg.MobSpawner.Spawner;
...
import com.Nodac_lzc_woshi85.MineRpg.MobSpawner.EntityMineType;
import com.Nodac_lzc_woshi85.MineRpg.MobSpawner.MineMain;
...
public class MonsterSpawner implements CustomMobSpawner {
	...
	private Location L;
	public MonsterSpawner(String name,int ATK,int DEF,double SPE,int Period,ItemStack[] Drops,EntityMineType Type,EntityEquipment EE,Location l)
	{
		this.name = name;
		this.ATK = ATK;
		this.DEF = DEF;
